    ...
    <div class="container">
        <div class="h-100 d-flex flex-column justify-content-center align-items-center my-5">
            ...
            <div>
                ...
                <p class="text-center text-muted">{{ __('Payment is made. Wait for at least 1 blockchain confirmation for the plan to change automatically. You can leave this page.') }}</p>
