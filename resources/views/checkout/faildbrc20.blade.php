...
@section('site_title', formatTitle([__('Payment faild'), config('settings.title')]))
...
<div class="bg-base-1 d-flex align-items-center flex-fill">
    <div class="container">
        <div class="h-100 d-flex flex-column justify-content-center align-items-center my-5">
            ...
            <div>
                <h5 class="mt-4 text-center">{{ __('Payment faild') }}</h5>
                <p class="text-center text-muted">{{ __('The payment was failded.Please contact to management team!') }}</p>
