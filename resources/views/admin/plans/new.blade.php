        ...
        <form action="{{ route('admin.plans.new') }}" method="post" enctype="multipart/form-data">
            ...
            <div class="form-group">
                ...
                <select name="currency" id="i-currency" class="custom-select{{ $errors->has('currency') ? ' is-invalid' : '' }}">
                    ...
                    @endforeach
                    <option value="XBAI" selected >{{ "XBAI"}} - {{ "XBAI Token" }}</option>
                </select>
            ...
            <div class="form-group">
                ...
                <input type="number" name="balance" id="i-balance" class="form-control{{ $errors->has('balance') ? ' is-invalid' : '' }}" value="{{ old('balance') ?? 0 }}">
